function [c_rgb, c_lab] = sample_between_colors_over(c1, c2, n, n_o)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
...
%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
c1 = rgb2lab(c1, 'WhitePoint', [1 1 1], 'ColorSpace', 'linear-rgb');
c2 = rgb2lab(c2, 'WhitePoint', [1 1 1], 'ColorSpace', 'linear-rgb');
