function [logLikely, predictedResponses] = MLDSComputeLogLikelihood_sigma(thePairs,theResponses,nTrials,xFit,yFit,sigma)
...
for i = 1:nPairs
    ...
    logLikely = logLikely + ( theResponses(i)*log(predictedResponses(i)) + (nTrials(i)-theResponses(i))*log(1-predictedResponses(i)) );
end
if (isnan(logLikely))
